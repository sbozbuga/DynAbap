...
*--------------------------------------------------------------------*
        ...
        " ⚡ Bolt: Explicitly SORT internal tables before DELETE ADJACENT DUPLICATES
        " to ensure all duplicates are grouped and removed, reducing table size and improving downstream BINARY SEARCH lookup performance.
