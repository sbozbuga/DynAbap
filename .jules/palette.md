...
## 2024-05-18 - Missing parameter label for background UX
...
**Action:** When adding or modifying selection screen parameters, always check if they need text descriptions in the text pool, especially if they are defined with `NO-DISPLAY`.
