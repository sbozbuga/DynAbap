...
## 2024-08-05 - Add text descriptions to NO-DISPLAY parameters
...
**Action:** When adding missing selection screen texts, ensure parameters with `NO-DISPLAY` also receive text entries in the default (`<TPOOL>`) and translated (`<I18N_TPOOL>`) text pools.
