...
## 2026-07-30 - Label text missing for NO-DISPLAY parameters
...
**Action:** Always ensure that `NO-DISPLAY` parameters have text symbols defined in the program's XML text pool.
